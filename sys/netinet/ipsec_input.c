...
/* In the order of ESPCTL_NAMES */
const struct sysctl_bounded_args espctl_vars[] = {
	{NULL},
	{&esp_enable, 0, 1},
	{&udpencap_enable, 0, 1},
	{&udpencap_port, 0, 65535},
	/* {NULL}, */
};
/* In the order of AHCTL_NAMES */
const struct sysctl_bounded_args ahctl_vars[] = {
	{NULL},
	{&ah_enable, 0, 1},
	/* {NULL}, */
};
/* In the order of IPCOMPCTL_NAMES */
...
/* In the order of IPSECCTL_NAMES */
const struct sysctl_bounded_args ipsecctl_vars[] = {
	...
	{&encdebug, 0, 1},
	{NULL}, /* ipsecstat */
	{&ipsec_expire_acquire, 0, INT_MAX},
	{&ipsec_keep_invalid, 0, INT_MAX},
	{&ipsec_require_pfs, 0, 1},
	{&ipsec_soft_allocations, 0, INT_MAX},
	{&ipsec_exp_allocations, 0, INT_MAX},
	{&ipsec_soft_bytes, 0, INT_MAX},
	{&ipsec_exp_bytes, 0, INT_MAX},
	{&ipsec_exp_timeout, 0, INT_MAX},
	{&ipsec_soft_timeout,0, INT_MAX},
	{&ipsec_soft_first_use, 0, INT_MAX},
	{&ipsec_exp_first_use, 0, INT_MAX},
};
